...
pyhop.declare_methods('movePiece',movePiece)
...
pyhop.declare_methods('navigateRobot', navigateRobot)
...
def work(state, goal):
    ...
    return []
pyhop.declare_methods('work',work)